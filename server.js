...
app.use(cors({
  origin: [
    'https://paintedloop.in',         // ← add
    'https://www.paintedloop.in',     // ← add
    'https://paintedloop.netlify.app',
    'https://admin-paintedloops.netlify.app',
    'https://paintedloops.pranjalnegi82.workers.dev',
    'http://localhost:3000'
  ],
  credentials: true
